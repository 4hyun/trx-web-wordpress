...
if (!get_next_post($bifrost_portfolio_item_category_bool) && !get_previous_post($bifrost_portfolio_item_category_bool)) {
    return;
}
    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="<?php echo esc_attr($bifrost_portfolio_item_navigation_nav_cols) ?> o-post-navigation__link prev">
                <?php previous_post_link('%link', '<div class="d-flex align-items-center"><div class="o-post-navigation__text-icon"><h6 class="o-post-navigation__title">'. esc_html__('Prev', 'bifrost') .'</h6><h6 class="o-post-navigation__subtitle">%title</h6></div></div>', $bifrost_portfolio_item_category_bool, '', 'category'); ?>
            </div>
            ...
            <div class="<?php echo esc_attr($bifrost_portfolio_item_navigation_nav_cols) ?> o-post-navigation__link next h-align-right">
                <?php next_post_link('%link', '<div class="d-flex align-items-center"><div class="o-post-navigation__text-icon"><h6 class="o-post-navigation__title">'. esc_html__('Next', 'bifrost') .'</h6><h6 class="o-post-navigation__subtitle">%title</h6></div></div>', $bifrost_portfolio_item_category_bool, '', 'category'); ?>
            </div>
        </div>
    </div>
    </div>
