        ...
        */
        ...
        <div class="l-theme-wrapper">
            ...
            */
            ...
            if (apply_filters('bifrost_display_header', true) && $bifrost_header_type != '2' || is_search()) :
            ...
            // Elementor
            if ($bifrost_header_type == '2' && $bifrost_header_template && apply_filters('bifrost_display_header_template', true ) && !is_search()) :
            ?>
